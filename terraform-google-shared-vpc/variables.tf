...
variable "private_service_connaction_address" {
  description = "private network connacation for CloudSQL"
  type        = string
  default     = ""
}
variable "create_private_connaction" {
  description = "create private network connacation for CloudSQL or not"
  type        = bool
  default     = false
}